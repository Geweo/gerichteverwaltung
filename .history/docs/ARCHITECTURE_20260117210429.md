...
Nutzt `supabase/config.toml`; startet Auth, Studio, Storage, PostgREST, etc. in Docker. Die App-DB (`ernaehrbar`, 5432) bleibt getrennt; Supabase nutzt eigene Postgres (z.B. 54322).

...
public class MealPlanFixture : SeedableFixture<DevelopmentFixtureSet>
{
    ...
    protected override async Task SeedAsync(CancellationToken cancellationToken)
    {
        ...
        await mealPlanEntries.AddEntry(CurrentWeekPlan, startDate, MealCategory.Breakfast, recipes.Pancakes, 1, cancellationToken);
        await mealPlanEntries.AddEntry(CurrentWeekPlan, startDate, MealCategory.Dinner, recipes.SpaghettiBolognese, 1, cancellationToken);
        await mealPlanEntries.AddEntry(CurrentWeekPlan, startDate.AddDays(1), MealCategory.Lunch, recipes.CaesarSalad, 2, cancellationToken);
    }
}

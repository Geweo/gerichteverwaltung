...
{
    /// <inheritdoc />
    public partial class MultiTenantDataModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomMealName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealPlanEntries_MealPlanId_Date_MealCategory",
                table: "MealPlanEntries",
                columns: new[] { "MealPlanId", "Date", "MealCategory" });

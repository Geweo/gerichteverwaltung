...
1. Check if a contract/client already exists in `src/contracts`.
...
## API contracts (generated in `src/contracts`)

- Files in `src/contracts` are generated. **Do not edit them manually.**
